...
1. On your Windows computer
	a.	Log onto your computer as usual and make sure you are connected to the internet.
	b.	Press Ctrl-Alt-Del and click on ""Change Password"".
	c.	Fill in your old password and set a new password.  See the password requirements below.
	d.	Press OK to return to your desktop. 
