$CSV = "C:\tmp\Office_365_User_Licensing.csv"
$Sku = @{
...
$fileNameFormat = "O365Licensing" + "-" + (Get-Date -Format "yyyy-MM-dd") + ".csv"
Rename-Item -Path "C:\tmp\Office_365_User_Licensing.csv" -NewName $fileNameFormat